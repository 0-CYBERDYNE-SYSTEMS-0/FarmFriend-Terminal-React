...
import type { SessionMode } from "../../session/sessionPolicy.js";

type WhatsAppGatewayOpts = {
...
export class WhatsAppGateway implements GatewayChannel {
  name = "whatsapp";
  ...
  constructor(opts: WhatsAppGatewayOpts) {
