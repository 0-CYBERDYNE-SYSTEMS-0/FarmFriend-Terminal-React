...
---
-- Get parameters
set appNameParam to "{app_name}"
if appNameParam is "" or appNameParam is "{app_name}" then
...
set volumeLevelParam to "{volume_level}"
if volumeLevelParam is "" or volumeLevelParam is "{volume_level}" then
