  ...
  tell application "Podcasts"
    try
      ...
      if podcastName is "" or podcastName is missing value then
        set podcastName to "{podcastName}"
      end if
      
      if episodeName is "" or episodeName is missing value then
        set episodeName to "{episodeName}"
      end if
      ...
      if podcastName is not "{podcastName}" and episodeName is not "{episodeName}" then
        ...
        if episodeName is not "{episodeName}" then
