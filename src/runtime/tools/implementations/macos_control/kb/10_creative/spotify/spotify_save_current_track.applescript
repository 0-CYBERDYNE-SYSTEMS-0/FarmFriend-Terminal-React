...
set outputFormat to "{output_format}"
if outputFormat is "" or outputFormat is "{output_format}" then
  set outputFormat to "text" -- Default to text format
end if

set saveLocation to "{save_location}"
if saveLocation is "" or saveLocation is "{save_location}" then
  set saveLocation to "desktop" -- Default to desktop
end if

set includeTimestamp to "{include_timestamp}"
if includeTimestamp is "" or includeTimestamp is "{include_timestamp}" then
