  ...
  tell application "Calendar"
    try
      ...
      if eventTitle is "" or eventTitle is missing value then
        set eventTitle to "{eventTitle}"
      end if
      
      if eventDateTime is "" or eventDateTime is missing value then
        set eventDateTime to "{eventDateTime}"
      end if
      ...
      if calendarName is "" or calendarName is missing value then
        set calendarName to "{calendarName}"
      end if
      ...
      if calendarName is not "{calendarName}" and calendarName is not "" then
        try
      ...
      if eventDateTime is not "{eventDateTime}" and eventDateTime is not "" then
        try
