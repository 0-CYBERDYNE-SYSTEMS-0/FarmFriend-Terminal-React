      ...
      <div ref={messagesContainerRef} className={`chat-scroll flex-1 overflow-y-auto px-4 py-6 relative ${isMobile && consoleVisible ? 'mb-[calc(45vh+6rem)]' : ''}`}>
        ...
        {showJumpToBottom && (
          <button
            ...
            className={`fixed z-50 inline-flex items-center justify-center gap-1.5 rounded-full bg-blue-600 text-white shadow-xl shadow-blue-900/40 border border-blue-400/50 hover:bg-blue-500 hover:scale-105 active:scale-95 transition-all duration-200 ${
              isMobile && consoleVisible
                ? 'bottom-[calc(45vh+5.5rem)] right-4 px-3 py-2'
                : isMobile
                  ? 'bottom-24 right-4 px-3 py-2'
