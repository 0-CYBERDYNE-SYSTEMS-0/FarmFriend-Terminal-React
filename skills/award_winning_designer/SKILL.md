---
name: "award_winning_designer"
slug: "award_winning_designer"
summary: "Awwwards Singularity - World-class Creative Technologist & WebGL Shader Artist for elite digital experiences"
description: "The 'Awwwards Singularity' - Transforms websites into breathtaking digital experiences through cinematic motion, 3D graphics, and avant-garde typography. Eradicates boring, template-based web design."
version: "1.0"
author: "FF-Terminal - Awwwards Enhancement"
priority: "maximum"  # Higher than standard skills for immediate activation
triggers:
  # High-intent premium triggers
  - award-winning
  - awwwards
  - cinematic web
  - webgl experience
  ...
  # Override triggers for basic web skills
...
config:
  ...
  tech_stack_modes:
    cinematic:
      description: "High-impact experiences with WebGL particles and smooth animations"
      requirements: ["high-impact", "motion-heavy", "brand-premium", "cinematic"]
      stack: ["three.js", "gsap", "lenis"]
      performance_tier: "high"
      
    minimal:
      description: "Elegant simplicity with modern CSS and subtle micro-interactions"
      requirements: ["elegant", "fast", "accessible", "minimal", "clean"]
      stack: ["vanilla", "modern-css", "web-animations-api"]
      performance_tier: "optimal"
      
    experimental:
      description: "Cutting-edge artistic expressions with custom shaders"
      requirements: ["cutting-edge", "prototype", "artistic", "experimental"]
      stack: ["webgl-shaders", "custom-animation-engine", "audio-api"]
      performance_tier: "maximum"
      
    hybrid:
      description: "Strategic blend of frameworks for balanced experiences"
      requirements: ["balanced", "versatile", "professional"]
      stack: ["css-framework", "vanilla-boost", "selective-libraries"]
      performance_tier: "balanced"

  # Visual metaphor translation engine
  metaphor_engine:
    security_firm: "WebGL particle shield reacting to mouse movement"
    coffee_shop: "Fluid dynamic shader simulations of mixing liquids"
    tech_startup: "Geometric constellation network with data flow"
    fashion_brand: "Fabric simulation with draping physics"
    architecture_firm: "3D building models with camera navigation"
    music_app: "Audio-reactive visualizer with waveform particles"
    finance_company: "Real-time data visualization with flowing charts"
    restaurant: "Steam particle effects and heat distortion shaders"
    art_gallery: "Virtual exhibition space with lighting effects"
    gaming_company: "Interactive game-like environment"
  ...
  typography_systems:
    ...
    - "letter_spacing_manipulation"
    - "text_reveal_animations"
    - "3d_text_effects"
  ...
  # Quality constraints
  quality_standards:
    performance_target: "60fps_minimum"
    accessibility_level: "wcag_aa_default"
    mobile_optimization: "progressive_enhancement"
    browser_support: "modern_first"
    production_ready: true
    seo_optimized: true
    
  # Output specifications
  output_format: "single_file_html"
  asset_optimization: "embedded_inline"
